...
const { DailyNutrition, dailyNutritionSchema } = require("../models/DailyNutrition")
...
class NutritionController {
  ...
  static async addNutrition(req, res, next) {
    try {
      ...
      const newDaily = new DailyNutrition({ details })

      let user = req.user
      user.profile.pregnancyData[0].dailyNutrition.push(newDaily)
