            ...
            <ScrollView style={{ paddingHorizontal: 25 }}>
                <View style={{ marginTop: 10, gap: 10 }}>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                        <Text style={{ flex: 1, paddingTop: 10, marginBottom: -5, fontSize: 16, fontFamily: "Poppins-SemiBold", borderRadius: 13 }} >Makanan</Text>
                        <Text style={{ width: 80, paddingTop: 10, marginBottom: -5, fontSize: 16, fontFamily: "Poppins-SemiBold", borderRadius: 13, }} >Value</Text>
                    </View>
                        ...
                        <View key={index} style={{ gap: 10 }}>
                            <View style={{ flexDirection: "row", gap: 8 }}>
                                ...
                                <TextInput
                                    ...
                                    style={{ borderWidth: 1, borderColor: "gray", width: 80, paddingTop: 10, paddingHorizontal: 10, paddingBottom: 6, fontSize: 16, fontFamily: "Poppins-Medium", borderRadius: 13 }}
                                    placeholder={'gr'}
                                />
                            </View>
                        </View>
                    ...
                    <View style={{ flexDirection: "row", marginTop: 10, gap: 5, alignItems: 'center' }}>
                        <Pressable style={{ flex: 1, padding: 10, marginRight: 5, backgroundColor: "black", borderRadius: 12 }} onPress={() => console.log('submitted')}>
