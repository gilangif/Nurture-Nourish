        ...
        <View style={{ backgroundColor: "white", flex: 1 }}>
            ...
            <ScrollView style={{ paddingHorizontal: 25 }}>
                <View style={{ marginTop: 10, justifyContent: "center", alignItems: "center" }}>
                    <Image style={{ width: 150, backgroundColor: "red", borderRadius: 100, height: undefined, aspectRatio: 1 }} source={{ uri: "https://storage.prompt-hunt.workers.dev/clh4m5fnm0004jq08x3ln0f4w_1" }} />
                    <Text style={{ fontFamily: "Poppins-SemiBold", fontSize: 25, marginVertical: 20 }}>
                        Floryn Georgianna
                    </Text>
